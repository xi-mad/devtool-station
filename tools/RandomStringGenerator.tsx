      ...
      <div className="w-full md:w-72 flex flex-col gap-6 bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 transition-colors">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <CheckboxOption label={t('random-string.uppercase_az')} checked={useUppercase} onChange={setUseUppercase} />
            <CheckboxOption label={t('random-string.lowercase_az')} checked={useLowercase} onChange={setUseLowercase} />
            <CheckboxOption label={t('random-string.numbers_09')} checked={useNumbers} onChange={setUseNumbers} />
            <CheckboxOption label={t('random-string.symbols')} checked={useSymbols} onChange={setUseSymbols} />
          </div>
        </div>
