    ...
    <div className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-180px)]">
      ...
      <div className="w-full lg:w-80 flex flex-col bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
         <div className="flex items-center gap-2 p-4 border-b border-slate-100 bg-slate-50/50">
           ...
           <h3 className="font-semibold text-slate-900">{t('qr-code.configuration')}</h3>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <div>
             <label className="block text-sm font-medium text-slate-700 mb-2">{t('qr-code.size')}: {size}px</label>
             <input 
                type="range" 
                min="128" 
                max="512" 
          ...
          <div className="grid grid-cols-2 gap-4">
              <div>
                 <label className="block text-sm font-medium text-slate-700 mb-2">{t('qr-code.foreground')}</label>
              ...
              <div>
                 <label className="block text-sm font-medium text-slate-700 mb-2">{t('qr-code.background')}</label>
                 <div className="flex items-center gap-2">
                    <input 
                        type="color" 
                        value={bgColor}
      ...
      <div className="flex-1 bg-white rounded-xl shadow-sm border border-slate-200 flex flex-col min-h-0 overflow-hidden">
         <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
           <div className="flex items-center gap-2">
             ...
             <h3 className="font-semibold text-slate-900">{t('qr-code.preview')}</h3>
           </div>
