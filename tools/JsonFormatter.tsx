...
export const JsonFormatter: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 flex flex-col h-[calc(100vh)] transition-colors">
      ...
      <div className="relative flex-1">
        ...
        />
        {error && (
          <ErrorDisplay message={error} className="absolute bottom-4 left-4 right-4 shadow-sm pointer-events-none" />
        )}
        {!error && input && (
